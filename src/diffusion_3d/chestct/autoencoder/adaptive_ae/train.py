...
from diffusion_3d.chestct.autoencoder.ae.model import AdaptiveAELightning
...
if config.training.start_from_checkpoint is not None:
    model = AdaptiveAELightning.load_from_checkpoint(
    ...
    model = AdaptiveAELightning(config.model, config.training)
