...
def get_config(training_image_size=(64, 64, 64)):
    ...
    latent_patch_size = tuple([2 ** len(model_config.encoder.blocks)] * 3)
    ...
    clearml_tags = [
        ...
        f"Dimensions: {[block.dim for block in model_config['encoder'].blocks]}",
        f"Latent dimensions: {model_config.encoder.latent.latent_dim}",
