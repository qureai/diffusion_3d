...
def get_config(training_input_size=(96, 96, 96)):
    ...
    training_config = munchify(
        dict(
            ...
            start_from_checkpoint=r"/raid3/arjun/checkpoints/diffusion_3d/v5__2025_05_15/version_0/checkpoints/last.ckpt",
            #
            max_epochs=1000,
            lr=1e-4,
            seed=42,
    ...
    clearml_tags = [
        ...
        #
        "LDM - MAISI VAE",
        "Moved back to timestep conditioning",
    ]

    additional_config = munchify(
        dict(
            task_name="v5__2025_05_15__epoch51",
            log_on_clearml=True,
